...
public class MSocketReadWriteTests
{
  ...
  public void setUp() throws Exception
  {
    ...
    mss = new MServerSocket(SOCKET_HRN, new NoProxyPolicy(), GnsCredentials.getDefaultCredentials(),
  ...
  public void readWrite100MB()
  {
    try
    {
      ...
      byte[] send = new byte[100 * 1024 * 1024];
      byte[] recv = new byte[100 * 1024 * 1024];
