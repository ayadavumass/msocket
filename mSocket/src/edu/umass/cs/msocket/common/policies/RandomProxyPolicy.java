...
public class RandomProxyPolicy extends ProxySelectionPolicy
{
  ...
  {
    this(proxyGroupName, 1, GnsCredentials.getDefaultCredentials());
  }
   ...
   */
  public RandomProxyPolicy(String proxyGroupName, int numProxy, GnsCredentials gnsCredentials)
  {
    ...
    if (gnsCredentials == null)
      throw new IllegalArgumentException("GNS credentials cannot be null");
  }
  ...
  public List<InetSocketAddress> getNewProxy() throws Exception
  {
    ...
    JSONArray members = gnsClient.groupGetMembers(groupGuid, gnsCredentials.getGuidEntry());
    ...
    { // Add each proxy to the list
      ...
      String serviceType = gnsClient.fieldRead(proxyGuid, GnsConstants.SERVICE_TYPE_FIELD, guidEntry).getString(0);
