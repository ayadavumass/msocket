  ...
  public void parse(String commandText) throws Exception
  {
    ...
    try
    {
      ...
      GuidEntry myGuid = KeyPairUtils.getGuidEntryFromPreferences(module.getGnsClient().getGnsHost() + ":"
          + module.getGnsClient().getGnsPort(), serviceName);
      ...
      if (myGuid == null)
      {
        ...
        myGuid = gnsClient.guidCreate(module.getAccountGuid(), serviceName);
      }
      ...
      LocationService locationer = new LocationService(module.getProxyGroupGuid().getEntityName(), serviceName,
          new GnsCredentials(gnsClient, module.getAccountGuid()));
