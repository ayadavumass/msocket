...
public class WatchdogListScanner extends Thread
{
   ...
   */
  public WatchdogListScanner(UniversalGnsClient gnsClient, GuidEntry watchdogGuid, String targetGuid, String listName,
  ...
  public void run()
  {
    ...
    while (!isKilled)
    {
      ...
      try
      {
        ...
        JSONArray guids = gnsClient.fieldRead(targetGuid, listName, watchdogGuid);
